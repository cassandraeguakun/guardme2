...
window.accounting = __webpack_require__(16);
...
=======
        ...
        getEmployees: function getEmployees() {
            ...
            this.employees.data = [];
            window.axios.get('/api/jobs/' + vm.selected_job.id + '/employees').then(function (response) {
        ...
        getRatings: function getRatings() {
            ...
            window.axios.get('/api/ratings/fetch').then(function (response) {
        ...
        markComplete: function markComplete(job) {
            var vm = this;
