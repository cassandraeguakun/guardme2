        ...
        getUser: function getUser() {
            ...
            window.axios.get('/api/user').then(function (response) {
                ...
                if (_this.user.phone) {
                    ...
                    _this.action = _this.user.phone_verified ? 'unbind' : 'confirm';
                }
            });
        },
        send: function send() {
            ...
            var url = '/api/verify/' + (this.action === 'confirm' ? 'confirm' : 'otp');

            window.axios.post(url, { code: code, phone: phone }).then(function (response) {
